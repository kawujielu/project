...
if __name__ == "__main__":
    api_key = "0b709ed7-8eb4-48a0-8851-930a4aacab38"
    seceret_key = "C512D2EB80B7755A834487131F358AC4"
    passphrase = "okapimmhs265199JJsy"
    spot = SpotAPI(api_key, seceret_key, passphrase)
    a = spot.get_trade_fee()
    print(a)